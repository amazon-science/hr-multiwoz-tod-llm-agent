...
parser.add_argument("--name", type=str, default="deepset/deberta-v3-large-squad2",
                    help="Model name for the question-answering pipeline")
parser.add_argument("--threshold", type=float, default=0.2,
                    help="Threshold for accepting answers")
...
for indx in range(data.shape[0]):
    ...
    for index in range(len(sgds)):
        ...
        for entity in template[types[0]]:
            ...
            extract = entity_extract(question, context[10:], thred = args.threshold)
